...
use \sk\module\testtaxonomy;

abstract class AbstractClassTest extends post_taxonomy
{
    private $base, $post_type;

    public function __construct() {
        $this->base = 'fabric'; # почему не статик
        $this->post_type = 'product'; # почему не статик
    }
